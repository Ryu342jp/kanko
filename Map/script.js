const locations = [
  ...
  {lat: 32.73390553577598,lng:129.87282338884566, name: 'HUBsIshibashi(13日交換所)', limited: false, electronic: false, foods: true, url: 'https://55hubs.localinfo.jp/', imageUrl: 'shopimage/HUB'},
  //{lat: 32.73435844854654, lng: 129.86922078278042 , name: 'グラバー園(14日交換所)', limited: false, electronic: false, foods: true, url: 'https://glover-garden.jp/', imageUrl: 'shopimage/grab'},
];
