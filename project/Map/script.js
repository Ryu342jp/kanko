const locations = [
    ...
    // ほかの店舗も同様に追加
    { lat: 32.74328627, lng: 129.877567, name: 'カラオケバー　モンキーガール', limited: true, electronic: true, foods: true, priority: 1, url: 'shop/カラオケバー　モンキーガール.html', imageUrl: 'image/None' },
    { lat: 32.74202052, lng: 129.8766215, name: '鉄板や万菜', limited: true, electronic: true, foods: true, priority: 1, url: 'shop/鉄板や万菜.html', imageUrl: 'image/None' },
    { lat: 32.74195341, lng: 129.8766262, name: 'ダイニング藤蔵', limited: true, electronic: true, foods: true, priority: 1, url: 'shop/ダイニング藤蔵.html', imageUrl: 'image/None' },
    { lat: 32.74200252, lng: 129.8766146, name: 'Bar Le.Cinq(ルサンク)', limited: true, electronic: true, foods: true, priority: 1, url: 'shop/Bar Le.Cinq(ルサンク).html', imageUrl: 'image/None' },
    { lat: 32.74251498, lng: 129.8772611, name: '焼肉かくら　銅座店', limited: true, electronic: true, foods: true, priority: 1, url: 'shop/焼肉かくら　銅座店.html', imageUrl: 'image/None' },
    { lat: 32.74270605, lng: 129.8773523, name: '三八　本店', limited: false, electronic: true, foods: true, priority: 1, url: 'shop/三八　本店.html', imageUrl: 'image/None' },
    { lat: 32.74256581, lng: 129.8781407, name: 'SUNNY SIDE（サニーサイド）', limited: true, electronic: false, foods: true, priority: 1, url: 'shop/SUNNY SIDE（サニーサイド）.html', imageUrl: 'image/None' },
    { lat: 32.74242757, lng: 129.8779054, name: 'スナック　律子', limited: true, electronic: true, foods: true, priority: 1, url: 'shop/スナック　律子.html', imageUrl: 'image/None' },
    { lat: 32.7426057, lng: 129.8780127, name: '長崎炉端　侘助', limited: true, electronic: true, foods: true, priority: 1, url: 'shop/長崎炉端　侘助.html', imageUrl: 'image/None' },
    { lat: 32.7426873, lng: 129.8775639, name: 'LAMB D（ラムディ）', limited: true, electronic: true, foods: true, priority: 1, url: 'shop/LAMB D（ラムディ）.html', imageUrl: 'image/None' },
    { lat: 32.74290743, lng: 129.8775222, name: 'アリラン亭', limited: true, electronic: true, foods: true, priority: 1, url: 'shop/アリラン亭.html', imageUrl: 'image/None' },
    { lat: 32.74298936, lng: 129.8780992, name: 'オルテンシア　ナガサキ', limited: true, electronic: true, foods: true, priority: 1, url: 'shop/オルテンシア　ナガサキ.html', imageUrl: 'image/None' },
    { lat: 32.7428248, lng: 129.8784074, name: '三八　銅座店', limited: false, electronic: true, foods: true, priority: 1, url: 'shop/三八　銅座店.html', imageUrl: 'image/None' },
    { lat: 32.74261094, lng: 129.878351, name: 'スナック＆BAR　Melissa(メリッサ)', limited: true, electronic: false, foods: true, priority: 1, url: 'shop/スナック＆BAR　Melissa(メリッサ).html', imageUrl: 'image/None' },
    { lat: 32.7426107, lng: 129.8783591, name: 'バートクナガ', limited: true, electronic: false, foods: true, priority: 1, url: 'shop/バートクナガ.html', imageUrl: 'image/None' },
];
    ...
    switch (area) {
        case 'A':
            return `
                ...
                <a href="https://www.google.com/search?q=インスタグラム+hama_bura" target="_blank"><img src="image/insta.png" alt="インスタグラム"></a>
            `;
        case 'B':
            return `
