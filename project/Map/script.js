const locations = [
    {lat: 32.74328627, lng: 129.877567, name: 'カラオケバー　モンキーガール', limited: true, electronic: true, foods: true, url: 'shop/カラオケバーモンキーガール.html', imageUrl: 'shopimage/monkeygirl.jpg'},
...
{lat: 32.74200252, lng: 129.8766146, name: 'Bar Le.Cinq(ルサンク)', limited: true, electronic: true, foods: true, url: 'shop/BarLeCinq(ルサンク).html', imageUrl: 'shopimage/LeCinq.jpg'},
...
{lat: 32.74256581, lng: 129.8781407, name: 'SUNNY SIDE（サニーサイド）', limited: true, electronic: false, foods: true, url: 'shop/SUNNYSIDEサニーサイド.html', imageUrl: 'shopimage/sunnyside.jpg'},
...
{lat: 32.7426873, lng: 129.8775639, name: 'LAMB D（ラムディ）', limited: true, electronic: true, foods: true, url: 'shop/LAMBDラムディ.html', imageUrl: 'shopimage/LAMBD.jpg'},
...
{lat: 32.7426311875746, lng: 129.878323094728, name: 'スナック＆BAR　Melissa(メリッサ)', limited: true, electronic: false, foods: true, url: 'shop/スナックBAR Melissaメリッサ.html', imageUrl: 'shopimage/Melissa.jpg'},
...
{lat: 32.74275172, lng: 129.8790281, name: '炭火やきとり武将門', limited: true, electronic: true, foods: true, url: 'shop/炭火やきとり武将門.html', imageUrl: 'shopimage/武将門.jpg'},
...
{lat: 32.74277127, lng: 129.8789761, name: 'DaisyHill デイジーヒル', limited: true, electronic: true, foods: true, url: 'shop/DaisyHillデイジーヒル.html', imageUrl: 'shopimage/DaisyHill.jpg'},
{lat: 32.7426973584194, lng: 129.879145530486, name: '中華居酒屋 陽龍', limited: true, electronic: true, foods: true, url: 'shop/中華居酒屋 陽龍.html', imageUrl: 'shopimage/中華居酒屋陽龍.jpg'},
{lat: 32.7427222404276, lng: 129.87922671124, name: 'よこはま　思案橋', limited: true, electronic: false, foods: true, url: 'shop/よこはま思案橋店.html', imageUrl: 'shopimage/よこはま思案橋.jpg'},
...
{lat: 32.7438648263907, lng: 129.877825407665, name: 'JINS（ハマクロス411 2F)', limited: false, electronic: true, foods: false, url: 'shop/JINSハマクロス4112F.html', imageUrl: 'shopimage/JINS.jpg'},
