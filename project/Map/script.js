const locations = [
    ...
    {lat: 32.7426555683021, lng: 129.87902897646, name: 'いけす居酒屋　川正', limited: true, electronic: true, foods: true, priority: 1.0, url: 'shop/いけす居酒屋　川正.html', imageUrl: 'image/None'},
    {lat: 32.7427712745024, lng: 129.878976112525, name: 'DaisyHill デイジーヒル', limited: true, electronic: true, foods: true, priority: 1.0, url: 'shop/DaisyHill デイジーヒル.html', imageUrl: 'image/None'},
    {lat: 32.74328627, lng: 129.877567, name: 'カラオケバー　モンキーガール', limited: true, electronic: true, foods: true, priority: 1.0, url: 'shop/カラオケバー　モンキーガール.html', imageUrl: 'image/None'},
